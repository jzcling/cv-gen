...
class CVParser:
    ...
    def keywords(self, text: str):
        ...
        regex_keywords = ['UAT', 'git', 'SQL', '[Nn]oSQL', 'Mongo(db|DB)', 'Cassandra', 
    ...
    def description_type(self, text: str):
        ...
        labels = ['skills and work experience', 'academic qualifications']
    ...
    def classes(self, job_title: str, description_type: str, text: str, multi_class: bool = True):
        ...
        labels = []
        if description_type == 'skills and work experience':
            labels = ['agile development', 'automated testing', 'backend development', 
                ...
                'code review', 'collaboration', 'communication of ideas', 'conducting training', 
                ...
                'written and verbal skills', 'adaptability', 'analytical', 
                'attention to detail', 'cross-functional', 
                'cross-geographical', 'diverse cultures', 'fast-paced environment', 
                'integrity', 'learning ability', 'open to learning', 'open to travel', 
                'resourcefulness', 'self-motivated', 'strategical', 'teaching ability', 
                'work under pressure']
